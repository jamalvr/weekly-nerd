...
De repo waar ik al mijn foto's van de sketchnotes en artikelen voor de minor web development 2018 neerzet. Ik heb één weekly nerd gemist van TAM-TAM. Verder is alles compleet van de weekly nerds.
...
7. [Vitaly](https://github.com/jamalvr/weekly-nerd/blob/master/sketchnotes/8-vitaly.md)
8. [Bruce](https://github.com/jamalvr/weekly-nerd/blob/master/sketchnotes/9-bruce.md)
